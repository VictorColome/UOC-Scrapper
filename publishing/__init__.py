...
def uploadCSV(token, csvpathtofile):
    ...
    data = {'name': ntpath.basename(csvpathtofile)}
    files = {'file': open(csvpathtofile, 'rb')}
    while True:
...
if __name__ == '__main__':
    ...
    uploadCSV(accesstoken, "../sample/csv/adaptador-usb_articles_attributes_20200406.csv")
